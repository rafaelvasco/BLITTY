...
// These bindings were modified for use
// with the Chroma Framework as necessary.
...
#pragma warning restore 0169
	    ...
	    */
		...
		public static unsafe int SDL_AudioInit(string? driver_name)
		{
            ...
            {
				return INTERNAL_SDL_AudioInit(null);
			}
	    ...
	    */
		...
		[DllImport(LibraryName, EntryPoint = "SDL_AndroidGetInternalStoragePath", CallingConvention = CallingConvention.Cdecl)]
		...
		[DllImport(LibraryName, EntryPoint = "SDL_AndroidGetExternalStoragePath", CallingConvention = CallingConvention.Cdecl)]
