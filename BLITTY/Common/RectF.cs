...
{
    private static readonly RectF _empty = new(0, 0, 0, 0);
    ...
    public Vector2 Center => new(Calc.Abs(X2 - X1) / 2, Calc.Abs(Y2 - Y1) / 2);

    public override bool Equals(object? obj) => obj is RectF i && Equals(i);
