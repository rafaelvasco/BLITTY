...
public class ChannelGroup : GameAsset, IChannelControl
{
    public readonly FMOD.ChannelGroup Native;

    internal readonly PointerLinker<ChannelGroup> _linker = new();
    ...
    public Vector3 Position3D
    {
        get
        {
            Native.get3DAttributes(out FMOD.VECTOR pos, out FMOD.VECTOR _);
    ...
    public float MaxDistance3D
    {
        get
        {
            Native.get3DMinMaxDistance(out var _, out var maxDistance);
            return maxDistance;
        }
        set =>
    ...
    {
        FMODAudio.FModSystem.createChannelGroup(name, out Native);
